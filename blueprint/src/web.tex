...
\author{David Ledvinka \and Eason Luan \and Werawis Asawapiromz \and Chandon Mandair \and Kiran Patel \and Heather McRobbie}
...
\begin{proof}
    \leanok
    \uses{thm:existence_of_polygonal_line, lemma:norm_sum_at_least_sum_norm, def:intervalLength, def:polygonalLineLength}
